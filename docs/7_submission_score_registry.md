...
| BeamPF | rogii-pp-replay-wpf0 | v1 | V16 | submission | 10.284 | 2026-07-30T01:32:48.567000Z | submitted | w_pf=0.0 (no PF blend) override on V13's exact config otherwise (tau=None, alpha=1.0), same artifact bundle | Worse than V13 by 0.332 -- dropping the PF blend entirely hurts; some PF weight is load-bearing |
